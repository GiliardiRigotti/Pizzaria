                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-container w3-half">
                            ...
                            <ul class="w3-ul">
                                ...
                                <?php
                                    ...
                                    $resultado = mysqli_query($con, "SELECT * FROM produtos WHERE categoria=40");
                        ...
                        <div class=" w3-container w3-half">                      
                            ...
                            <ul class="w3-ul">
                                ...
                                <?php
                                    $resultado = mysqli_query($con, "SELECT * FROM produtos WHERE categoria=38");
                            ...
                            <ul class="w3-ul">
                                ...
                                <?php
                                    $resultado = mysqli_query($con, "SELECT * FROM produtos WHERE categoria=39");
                            ...
                            <ul class="w3-ul">
                                ...
                                <?php
                                    $resultado = mysqli_query($con, "SELECT * FROM produtos WHERE categoria=35");
